...
func (t *Tgbot) asnwerCallback(callbackQuery *telego.CallbackQuery, isAdmin bool) {
	...
	case "get_config_url":
		t.SendMsgToTgbot(chatId, t.getConfigURL())
	}
}
...
func (t *Tgbot) SendAnswer(chatId int64, msg string, isAdmin bool) {
	numericKeyboard := tu.InlineKeyboard(
		//tu.InlineKeyboardRow(
		//	tu.InlineKeyboardButton(t.I18nBot("tgbot.buttons.serverUsage")).WithCallbackData(t.encodeQuery("get_usages")),
		...
		//),
		tu.InlineKeyboardRow(
			tu.InlineKeyboardButton(t.I18nBot("tgbot.buttons.getConfigURL")).WithCallbackData(t.encodeQuery("get_config_url")),
...
func (t *Tgbot) getConfigURL() string {
	return "vmess:"
}
